...
curr_frame_id = 29
prev_frame_id = 28
pkl_path = './part_3/pkl/dusseldorf_000049.pkl'
prev_img_path = './part_3/pkl/dusseldorf_000049_0000' + str(prev_frame_id) + '_leftImg8bit.png'
curr_img_path = './part_3/pkl/dusseldorf_000049_0000' + str(curr_frame_id) + '_leftImg8bit.png'
